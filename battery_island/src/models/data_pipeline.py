        ...
        features=tf.train.Features(
            feature={
                cst.INTERNAL_RESISTANCE_NAME:
                    tf.train.Feature(float_list=tf.train.FloatList(value=ir_value)),
                cst.QD_NAME:
                    tf.train.Feature(float_list=tf.train.FloatList(value=qd_value)),
                cst.REMAINING_CYCLES_NAME:
                    tf.train.Feature(float_list=tf.train.FloatList(value=rc_value)),
                cst.DISCHARGE_TIME_NAME:
                    tf.train.Feature(float_list=tf.train.FloatList(value=dt_value)),
                cst.QDLIN_NAME:
                    tf.train.Feature(float_list=tf.train.FloatList(value=qdlin_value)),
                cst.TDLIN_NAME:
                    tf.train.Feature(float_list=tf.train.FloatList(value=tdlin_value)),
                cst.CURRENT_CYCLE_NAME:
                    tf.train.Feature(float_list=tf.train.FloatList(value=cc_value))
            }
        )
    )
